...
# --- НАСТРОЙКИ ---
TOKEN = '8610904464:AAEnYRtX4R5-6v5gvM6ZiCHUkibm6GscK00' # Это токен твоего Telegram бота. Не меняй его, если не хочешь создавать нового бота.
WEB_APP_URL = "https://твой-сайт.onrender.com" # !!!ВАЖНО!!! Сюда нужно вставить ту ссылку, которую тебе даст Render.com после успешного деплоя. Игра будет работать по этой ссылке.
